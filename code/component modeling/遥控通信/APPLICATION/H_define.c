...
//设置系统运行时钟为168MHz时，时钟周期为1/168us,机器周期，即一个基本操作周期（取指令，读写存储器等）
//为12个时钟周期，1/14us，指令周期，即执行一条指令的周期为1-4个机器周期，最多约为0.3us
//也就是1us至少能运行3条代码。
	
	MY_NVIC_PriorityGroupConfig(2);//设置中断优先级分组为2
	...
	#if __USART3
		Usart3_init(42,100000);	//串口初始化为100000 
	#endif
	...
	////////////TIM//////////////
		...
		TIM7_Init(5000,84); 					//频率84M/5000/84=200HZ
	#endif
